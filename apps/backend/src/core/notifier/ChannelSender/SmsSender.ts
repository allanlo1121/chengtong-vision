...
export function buildSignature(username: string, password: string, timestamp: string): string {
...
//     content: string,              // 内容
//     mobiles: string[] | string = DEFAULT_SMS_CONFIG.mobiles,
