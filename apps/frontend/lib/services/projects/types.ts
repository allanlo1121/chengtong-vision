...
export type SupabaseProjectOverviewRaw = {
  ...
  project_management_mode_code: string | null;
  project_management_mode_name: string | null;

  project_risk_level_code: string | null;
  project_risk_level_name: string | null;

  project_type_code: string | null;
  project_type_name: string | null;

  project_status_code: string | null;
  project_status_name: string;

  project_attention_level_code: string | null;
  project_attention_level_name: string | null;

  project_control_level_code: string | null;
  project_control_level_name: string | null;

  progress_status_code: string | null;
  progress_status_name: string | null;

  sub_project_type_code: string | null;
  sub_project_type_name: string | null;

  sub_project_attention_level_code: string | null;
