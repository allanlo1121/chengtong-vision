...
create trigger trg_hr.employees_audit_updated
...
create trigger trg_hr.educations_audit_updated
...
create trigger trg_hr.employee_posts_audit_updated
before update on hr.employee_posts
for each row
execute function system.set_audit_on_update();


alter table hr.employee_posts_history
add column created_at timestamptz default now();
...
create trigger trg_hr.employee_posts_history_audit_updated
before update on hr.employee_posts
for each row
execute function system.set_audit_on_update();
...
create trigger trg_hr.employee_titles_audit_updated
